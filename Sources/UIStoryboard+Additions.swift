...
extension UIStoryboard {
    ...
    class func networkInfoBottomSheet() -> UIViewController? {
        return UIStoryboard.loopMode().instantiateViewController(withIdentifier: "kRMBTNetworkInfoViewController")
    }
    ...
    class func mapBottomSheet() -> UIViewController? {
        return UIStoryboard.map().instantiateViewController(withIdentifier: "kRMBTMapBottomSheetViewController")
    }
