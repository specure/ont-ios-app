...
// MARK: Speed chart
    ...
    @IBAction func resultsButtonClick(_ sender: Any) {
        ...
        MeasurementHistory.sharedMeasurementHistory.getHistoryWithFilters(filters: nil, size: 1, page: 0, success: { [weak self] response in
...
//            self.manageViewsAbort()
    ...
    override func viewWillLayoutSubviews() {
        ...
        if RMBTConfiguration.RMBT_VERSION > 1 {
