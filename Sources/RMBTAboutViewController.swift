...
class RMBTAboutViewController: UIViewController {
    ...
    func prepareItems() {
        ...
        let sponsor1 = Item()
        sponsor1.image = UIImage(named: "logo_Akos")
        sponsor1.mode = .sponsor
        items.append(sponsor1)
        
        let sponsor2 = Item()
        sponsor2.image = UIImage(named: "logo_RUSR")
        sponsor2.mode = .sponsor
        items.append(sponsor2)
        
        let sponsor3 = Item()
        sponsor3.image = UIImage(named: "logo_cznic")
        sponsor3.mode = .sponsor
        items.append(sponsor3)
        
        let sponsor4 = Item()
        sponsor4.image = UIImage(named: "logo_CTU")
        sponsor4.mode = .sponsor
        items.append(sponsor4)
        
        let bigSponsor = Item()
        bigSponsor.image = UIImage(named: "en_horizontal_cef_logo_2")
