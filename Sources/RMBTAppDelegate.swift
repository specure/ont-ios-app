...
//        LocaleManager.setup()
        ...
        RMBTSettingsViewController.updateControlServer()
...
//        #endif
    ...
    func applyAppearance() {
        ...
        if #available(iOS 13.0, *) {
            ...
            navigationBarAppearance.backgroundColor = RMBTColorManager.navigationBarBackground
            ...
            tabBarAppearance.backgroundColor = RMBTColorManager.tabBarBackgroundColor
