...
class RMBTColorScheme: NSObject {
    ...
    var tintLightColor: UIColor {
        return RMBTTintColorLighter
    }
    ...
    var mapSelectionColor: UIColor {
        return RMBTMapSelectionColor
    }
    
    var progressPrimaryColor: UIColor {
        return RMBTProgressColorPrimaryLight
    }
    
    var progressSecondaryColor: UIColor {
        return RMBTProgressColorSecondaryLight
    }
}
