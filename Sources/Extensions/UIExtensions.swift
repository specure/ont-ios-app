...
extension UIViewController {
    ...
    func updateColorForNavigationBarAndTabBar() {
        if #available(iOS 13.0, *) {
            self.navigationController?.navigationBar.standardAppearance.backgroundColor = RMBTColorManager.navigationBarBackground
            self.navigationController?.navigationBar.scrollEdgeAppearance?.backgroundColor = RMBTColorManager.navigationBarBackground
        } else {
        ...
        if #available(iOS 13.0, *) {
            self.tabBarController?.tabBar.standardAppearance.backgroundColor = RMBTColorManager.tabBarBackgroundColor
        }
        if #available(iOS 15.0, *) {
            self.tabBarController?.tabBar.scrollEdgeAppearance?.backgroundColor = RMBTColorManager.tabBarBackgroundColor
        }
