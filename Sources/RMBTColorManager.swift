...
class RMBTColorManager: NSObject {
    ...
    static var tintLightColor: UIColor {
        return RMBTColorManager.shared.scheme.tintLightColor
    }
    ...
    static var mapSelectionColor: UIColor {
        return RMBTColorManager.shared.scheme.mapSelectionColor
    }
    
    static var progressPrimaryColor: UIColor {
        return RMBTColorManager.shared.scheme.progressPrimaryColor
    }
    
    static var progressSecondaryColor: UIColor {
        return RMBTColorManager.shared.scheme.progressSecondaryColor
    }
