...
class RMBTLoopModeTableViewCell: UITableViewCell {
    ...
    var loopModeModelView: RMBTLoopModeModelView? {
        didSet {
            ...
            self.titleLabel.textColor = loopModeModelView?.isLoading == true || loopModeModelView?.isDone == true ? activatedColor : inactiveColor
            self.valueLabel.textColor = loopModeModelView?.isLoading == true || loopModeModelView?.isDone == true ? activatedColor : inactiveColor
            self.medianLabel.textColor = loopModeModelView?.isLoading == true || loopModeModelView?.isDone == true ? activatedColor : inactiveColor
